  ...
  return (
    <>
      <Box>
        <Box>
          <Box>
            <Typography mt={2} fontSize={35}>
              Welcome
              <Typography component="span" fontSize={35}>
                {" "}
          ...
          >
            <Link className="link-container" to="/my-account/profile">
              ...
              >
                ...
                <Box>
                  <Typography mt={4}>My profile</Typography>
            ...
            <Link className="link-container" to="/my-account/history">
              ...
              >
                ...
                <Box>
                  <Typography mt={4}>Purchase History</Typography>
                  <Typography component="span">
                    {" "}
            ...
            <Link className="link-container" to="/my-account/wishlist">
              ...
              >
                ...
                <Box>
                  <Typography mt={4}>wishlist</Typography>
                  <Typography component="span">Manage your wishlist</Typography>
                </Box>
              </Box>
            </Link>
            <Link className="link-container" to="/my-account/address-book">
              ...
              >
                ...
                <Box>
                  <Typography mt={4}>Address book</Typography>
                  <Typography component="span">
